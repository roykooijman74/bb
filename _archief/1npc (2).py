...
#    zoekplaatje("images/i-gefeliciteerd.jpg", npcteller, 70, rois=SMURFWINDOWS, wait=0.1)
    #zoekplaatje("images/npc-beloning.png", npcteller, 70, rois=SMURFWINDOWS, wait=0.1)
